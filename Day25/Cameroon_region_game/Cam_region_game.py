...
#     print(x, y)
#
# coordinate_dict = { 'regions': ["Bamenda", "Buea", "Yaounde", "Douala", "Bafousam", "Ebolowa", "Bertoua",
# "Ngoundere", "Garoua", "Maroua"], 'x_coor': [x_list], 'y_coor': [y_list] } df = pandas.DataFrame(coordinate_dict)
...
while len(entered_states) < 50:
    ...
    if players_ans == "Exit":
        ...
        state_list = [state_list.remove(guess_state) for guess_state in state_list if guess_state in entered_states]
